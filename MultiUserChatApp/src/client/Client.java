...
public class Client {
     ...
     /*
     * Client constructor to connect to the server, store input/output streams and setup GUI for client interaction 
     */
    public Client() {

        // logger implementation attempt
        SwingUtilities.invokeLater(() -> {
            try {
                ...
                errorLogger.log(Level.SEVERE, "Could not connect to server", ioe);
	 ...
	 * set global chatting GUI
        ...
        globalChatArea.setFont(globalChatArea.getFont().deriveFont(14f));
